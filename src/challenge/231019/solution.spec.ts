...
describe('231019 문제풀이', () => {
  ...
  describe('배열 자르기', () => {
    it.each([
      ...
      'numbers의 num1 인덱스부터, num2 인덱스 까지 자른 정수 배열 return',
      ({ numbers, num1, num2, expected }) => {
        expect(solution.sliceArray(numbers, num1, num2)).toStrictEqual(
          expected,
        );
      },
    );
